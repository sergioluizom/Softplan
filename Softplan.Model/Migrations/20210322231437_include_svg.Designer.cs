...
namespace Softplan.Domain.Migrations
{
    ...
    [Migration("20210322231437_include_svg")]
    partial class include_svg
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Softplan.Model.Entities.Flag", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Softplan.Model.Entities.Country", b =>
                {
                    b.HasOne("Softplan.Model.Entities.Flag", "Flag")
                        .WithMany()
